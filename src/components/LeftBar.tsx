...
const LeftBar = () => {
  ...
  const WebList = () => (
    <div>
      <a href="https://fake-product-identification-using-blockchain-one.vercel.app/">
        <div className="ml-12 flex items-center hover:cursor-pointer hover:bg-opacity-80 hover:bg-[#2b2a2a] w-60">
          ...
          />
          <p>Anti Counterfeiting and Traceability Detection System</p>
        </div>
      </a>
      ...
      <a href="https://code-editor-9a67pcs6s-1999matrixs-projects.vercel.app/">
      ...
      <a href="https://dropbox-clone-nine-coral.vercel.app/">
      ...
      <div>
        ...
        <div className="absolute inset-x-0 bottom-10 ">
          <div className="flex px-3 space-x-5">
            <a href="https://github.com/1999matrix">
              <img
                src={GitLogo}
                alt="Git Logo"
            ...
            <a href="https://codeforces.com/profile/_joKer_0">
              <img
                src={KaggleLogo}
                alt="Kaggle Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
            ...
            <a href="https://leetcode.com/1999matrix/">
              <img
                src={leetcode}
                alt="leetcode Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
            ...
            <a href="mailto:shashwatsd44@gmail.com">
              <img
                src={MailLogo}
                alt="Mail Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
